...
;(function ( $, window, document, undefined ) {
    ...
    function Plugin( element, options ) {
		...
		//valido q la pagina inicial no sea mayor al total de paginas, en caso de ser asi le resto 1
		var valPagIni = false
		while(valPagIni == false)
		{
			if(this._numPages < this.options.startPage)
			{
    ...
    Plugin.prototype.setStyles = function () {
        ...
        if ( this._cssAnimSupport && this.options.animation.length ) { 
            ...
            //this._items.hide();
            this._items.addClass('jp-hidden');
        }
