            ...
            <table class="responsive table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><input type="date" name="fecha_emision" id="fecha_emision" class="fecha validate[required,custom[date2]]" value="<?=$data['fecha_emision']?>" /></td>
                    </tr>
                    <tr>
                    	<td><label>Valor de la Factura</label></td>
                        <td><input type="number" name="valor" id="valor" class="validate[required,custom[numberP]]"  value="<?=$data['valor']?>" /></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" id="autoc-idparentesco" class="validate[required,funcCall[_validarHiddenAutoC]] autoc_txt" value="<?=$data['desc_parentesco']?>" />
                            <input type="hidden" id="idparentesco" name="idparentesco" value="<?=$data['idparentesco']?>" />
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>
                        	<input type="date" name="fecha_autorizacion_servicio" id="fecha_autorizacion_servicio" class="fecha validate[required,custom[onlyLetterNumber]]" value="<?=$data['fecha_autorizacion_servicio']?>" />
                        </td>
                    </tr>
                    <tr>
                        <td><label>Fecha Ingreso del Paciente</label></td>
                        <td>
                        	<input type="date" name="fecha_ingreso_paciente" id="fecha_ingreso_paciente" class="fecha validate[required,custom[onlyLetterNumber]]" value="<?=$data['fecha_ingreso_paciente']?>" />
                        </td>
                    </tr>
                    <tr>
                        <td><label>Fecha Salida del Paciente</label></td>
                        <td>
                        	<input type="date" name="fecha_egreso_paciente" id="fecha_egreso_paciente" class="fecha validate[required,custom[onlyLetterNumber]]" value="<?=$data['fecha_egreso_paciente']?>" />
                        </td>
                    </tr>
                    <tr>
            ...
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><input type="date" name="fecha_contrato" id="fecha_contrato" class="validate[required,custom[TextoAcentosNum]] fecha" value="<?=$data['fecha_contrato']?>" /></td>
                    </tr>
                    <tr>
                        <td><label>Valor</label></td>
                        <td><input type="number" name="valor_contrato" id="valor_contrato" class="validate[required,custom[numberP]]" value="<?=$data['valor_contrato']?>" /></td>
                    </tr>
                    <tr>
                        <td><label>Proveedor</label></td>
                        <td>
