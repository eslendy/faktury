...
<div id="contenido" class="dividido">
    <div class="partes">
        <fieldset>
            ...
            <form id="editAuditoria" class="formulario">
                <input type="hidden" name="idFactura" id="idFactura" value="<?= $_REQUEST['id'] ?>" />
                <input type="hidden" name="idauditoria_medica" id="idauditoria_medica" value="<?= $auditoriaMedica['idauditoria_medica'] ?>" />
                ...
                <table class="responsive table">
                    <tbody>
                        <tr>
                            ...
                            <td>
                                <?= $contrato->_select("c.idproveedor=" . $auditoriaMedica['idproveedor'], "modalidad_pago", "modalidad_pago", $data['contrato']) ?>
                            </td>
                        </tr>
                        <tr>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="input-prepend">
                                                        <span class="add-on">$</span>
                                                        <input type="number" name="glosa_valor_pagar_primera_glosa" readonly="true" value="<?php echo abs($data['valor'] - $total___) ?>" data-valor-factura="<? echo $auditoriaMedica['glosa_valor_pagar_primera_glosa'] ?>" id="prependedInput" class=" pesos valor_a_pagar_primera_audioria" />
                                                    </div>
                                                </td>
                                            </tr>
...
<script>
                            ...
                            $(function() {
                                ...
                                $('.addnewvalue').click(function(e) {
                                            ...
                                            $.post(init.XNG_WEBSITE_URL + '/auditoria_medica/ajax/loadAndSaveValorGlosa.php?type=edit', $($(this).attr('data-form')).serialize(), function(data) {
