...
class BD {
    ...
    public function ejecutarInsertArrayExistsUpdate($array, $table, $select = '', $while = '') {

        $sql = $select;
        $result_ = $this->consultar_total($sql);
       
        if (count($result_) > 0) {
            $result = $this->ejecutarUpdateArray($array, $table, $while);
